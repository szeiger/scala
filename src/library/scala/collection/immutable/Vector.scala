...
import VectorStatics.{Arr1, Arr2, Arr3, Arr4, Arr5, Arr6}
...
sealed abstract class Vector[+A]
  ...
  override def iterator: Iterator[A] = new VectorIterator(this)
  ...
  override def stepper[S <: Stepper[_]](implicit shape: StepperShape[A, S]): S with EfficientSplit = {
    ...
    val s = shape.shape match {
      case StepperShape.IntShape    => new IntVectorStepper(new VectorIterator(this).asInstanceOf[VectorIterator[Int]])
      case StepperShape.LongShape   => new LongVectorStepper(new VectorIterator(this).asInstanceOf[VectorIterator[Long]])
      case StepperShape.DoubleShape => new DoubleVectorStepper(new VectorIterator(this).asInstanceOf[VectorIterator[Double]])
      case _                        => shape.parUnbox(new AnyVectorStepper[A](new VectorIterator(this)))
    }
...
/** Empty vector */
private final object Vector0 extends Vector[Nothing] {
  import VectorStatics._

  def length = 0
  def apply(index: Int) = throw new IndexOutOfBoundsException

  override def updated[B >: Nothing](index: Int, elem: B): Vector[B] = throw new IndexOutOfBoundsException
...
private final class Vector1[+A](data1: Arr1) extends Vector[A] {
  import VectorStatics._
  ...
  override def updated[B >: A](index: Int, elem: B): Vector[B] = {
    ...
    new Vector1(copyUpdate(data1, index, elem))
  }
  ...
  override def appended[B >: A](elem: B): Vector[B] = {
    if(length < WIDTH) {
      ...
      new Vector1(a)
    } else new Vector2(data1, WIDTH, empty2, wrap1(elem), WIDTH+1)
  }

  override def prepended[B >: A](elem: B): Vector[B] = {
    if(length < WIDTH) new Vector1(copyPrepend1(elem, data1))
    else new Vector2(wrap1(elem), 1, empty2, data1, length+1)
  }
  ...
  override def map[B](f: A => B): Vector[B] = new Vector1(mapElems1(data1, f))
  ...
  protected[this] def slice0(lo: Int, hi: Int): Vector[A] =
    new Vector1(copyOfRange(data1, lo, hi))

  override def tail: Vector[A] =
    if(data1.length == 1) Vector0
    else new Vector1(copyTail(data1))

  override def init: Vector[A] =
    if(data1.length == 1) Vector0
    else new Vector1(copyInit(data1))
...
private final class Vector2[+A](prefix1: Arr1, len1: Int,
                                 data2: Arr2,
                                 suffix1: Arr1,
                                 val length: Int) extends Vector[A] {
  import VectorStatics._
  ...
  @inline private[this] def copy(prefix1: Arr1 = prefix1, len1: Int = len1,
                                 ...
                                 length: Int = length) =
    new Vector2(prefix1, len1, data2, suffix1, length)
  ...
  override def appended[B >: A](elem: B): Vector[B] = {
    ...
    else new Vector3(prefix1, len1, data2, WIDTH*(WIDTH-2) + len1, empty3, wrap2(suffix1), wrap1(elem), length+1)
  }
  ...
  override def prepended[B >: A](elem: B): Vector[B] = {
    ...
    else new Vector3(wrap1(elem), 1, wrap2(prefix1), len1+1, empty3, data2, suffix1, length+1)
  }
...
private final class Vector3[+A](prefix1: Arr1, len1: Int,
  ...
  @inline private[this] def copy(prefix1: Arr1 = prefix1, len1: Int = len1,
                                 ...
                                 length: Int = length) =
    new Vector3(prefix1, len1, prefix2, len12, data3, suffix2, suffix1, length)
  ...
  override def appended[B >: A](elem: B): Vector[B] = {
    ...
    else new Vector4(prefix1, len1, prefix2, len12, data3, (WIDTH-2)*WIDTH2 + len12, empty4, wrap3(copyAppend(suffix2, suffix1)), empty2, wrap1(elem), length+1)
  }
  ...
  override def prepended[B >: A](elem: B): Vector[B] = {
    ...
    else new Vector4(wrap1(elem), 1, empty2, 1, wrap3(copyPrepend(prefix1, prefix2)), len12+1, empty4, data3, suffix2, suffix1, length+1)
  }
...
private final class Vector4[+A](prefix1: Arr1, len1: Int,
                                 prefix2: Arr2, len12: Int,
  ...
  @inline private[this] def copy(prefix1: Arr1 = prefix1, len1: Int = len1,
                                 ...
                                 length: Int = length) =
    new Vector4(prefix1, len1, prefix2, len12, prefix3, len123, data4, suffix3, suffix2, suffix1, length)
  ...
  override def appended[B >: A](elem: B): Vector[B] = {
    ...
    else new Vector5(prefix1, len1, prefix2, len12, prefix3, len123, data4, (WIDTH-2)*WIDTH3 + len123, empty5, wrap4(copyAppend(suffix3, copyAppend(suffix2, suffix1))), empty3, empty2, wrap1(elem), length+1)
  }
  ...
  override def prepended[B >: A](elem: B): Vector[B] = {
    ...
    else new Vector5(wrap1(elem), 1, empty2, 1, empty3, 1, wrap4(copyPrepend(copyPrepend(prefix1, prefix2), prefix3)), len123+1, empty5, data4, suffix3, suffix2, suffix1, length+1)
  }
...
private final class Vector5[+A](prefix1: Arr1, len1: Int,
                                 prefix2: Arr2, len12: Int,
                                 prefix3: Arr3, len123: Int,
  ...
  @inline private[this] def copy(prefix1: Arr1 = prefix1, len1: Int = len1,
                                 ...
                                 length: Int = length) =
    new Vector5(prefix1, len1, prefix2, len12, prefix3, len123, prefix4, len1234, data5, suffix4, suffix3, suffix2, suffix1, length)
  ...
  override def appended[B >: A](elem: B): Vector[B] = {
    ...
    else new Vector6(prefix1, len1, prefix2, len12, prefix3, len123, prefix4, len1234, data5, (WIDTH-2)*WIDTH4 + len1234, empty6, wrap5(copyAppend(suffix4, copyAppend(suffix3, copyAppend(suffix2, suffix1)))), empty4, empty3, empty2, wrap1(elem), length+1)
  }
  ...
  override def prepended[B >: A](elem: B): Vector[B] = {
    ...
    else new Vector6(wrap1(elem), 1, empty2, 1, empty3, 1, empty4, 1, wrap5(copyPrepend(copyPrepend(copyPrepend(prefix1, prefix2), prefix3), prefix4)), len1234+1, empty6, data5, suffix4, suffix3, suffix2, suffix1, length+1)
  }
...
private final class Vector6[+A](prefix1: Arr1, len1: Int,
                                 prefix2: Arr2, len12: Int,
                                 prefix3: Arr3, len123: Int,
                                 prefix4: Arr4, len1234: Int,
  ...
  @inline private[this] def copy(prefix1: Arr1 = prefix1, len1: Int = len1,
                                 ...
                                 length: Int = length) =
    new Vector6(prefix1, len1, prefix2, len12, prefix3, len123, prefix4, len1234, prefix5, len12345, data6, suffix5, suffix4, suffix3, suffix2, suffix1, length)
...
/** Helper class for vector slicing. It is initialized with the validated start and end index,
  ...
  */
private[immutable] final class VectorSliceBuilder(lo: Int, hi: Int) {
...
private final class VectorBuilder[A] extends ReusableBuilder[A, Vector[A]] {
  import VectorStatics._
  ...
  def initFrom(v: Vector[_]): this.type = {
...
private[immutable] object VectorStatics {
...
private[immutable] final class VectorIterator[A](v: Vector[A]) extends Iterator[A] with java.lang.Cloneable {
  import VectorStatics._
  ...
  protected[immutable] def split(at: Int): VectorIterator[A] = {
    val it2 = clone().asInstanceOf[VectorIterator[A]]
    it2.take(at)
    drop(at)
    it2
  }
...
private[immutable] abstract class VectorStepperBase[A, Sub >: Null <: Stepper[A], Semi <: Sub](it: VectorIterator[A])
  extends Stepper[A] with EfficientSplit {

  protected[this] def build(it: VectorIterator[A]): Semi
...
private[immutable] class AnyVectorStepper[A](it: VectorIterator[A])
  extends VectorStepperBase[A, AnyStepper[A], AnyVectorStepper[A]](it) with AnyStepper[A] {
  protected[this] def build(it: VectorIterator[A]) = new AnyVectorStepper(it)
  def nextStep(): A = it.next()
}

private[immutable] class DoubleVectorStepper(it: VectorIterator[Double])
  extends VectorStepperBase[Double, DoubleStepper, DoubleVectorStepper](it) with DoubleStepper {
  protected[this] def build(it: VectorIterator[Double]) = new DoubleVectorStepper(it)
  def nextStep(): Double = it.next()
}

private[immutable] class IntVectorStepper(it: VectorIterator[Int])
  extends VectorStepperBase[Int, IntStepper, IntVectorStepper](it) with IntStepper {
  protected[this] def build(it: VectorIterator[Int]) = new IntVectorStepper(it)
  def nextStep(): Int = it.next()
}

private[immutable] class LongVectorStepper(it: VectorIterator[Long])
  extends VectorStepperBase[Long, LongStepper, LongVectorStepper](it) with LongStepper {
  protected[this] def build(it: VectorIterator[Long]) = new LongVectorStepper(it)
